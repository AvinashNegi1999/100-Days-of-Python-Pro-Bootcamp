...
with open(
    r"C:\Users\avina\OneDrive\Documents\GitHub\100-Days-of-Python-Code-challenge\Day 024\Mail Merge Project Start\Input\Names\invited_names.txt"
) as invited_names:
    names_list = invited_names.readlines()  # * Reads all lines into a list

# * Read the letter template from starting_letter.txt
with open(
    r"C:\Users\avina\OneDrive\Documents\GitHub\100-Days-of-Python-Code-challenge\Day 024\Mail Merge Project Start\Input\Letters\starting_letter.txt"
) as file:
...
for name in names_list:
    ...
    with open(
        rf"C:\Users\avina\OneDrive\Documents\GitHub\100-Days-of-Python-Code-challenge\Day 024\Mail Merge Project Start\Output\ReadyToSend\letter_for_{name}.txt",
